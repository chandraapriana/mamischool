...
public class DialogDeleteAchievement extends AppCompatDialogFragment {
    ...
    public DialogDeleteAchievement(Activity activity){
        this.activity = activity;
    }
    public DialogDeleteAchievement(){}
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                DocumentReference noteRef = fStore.collection("schoolAchievment").document(header);
