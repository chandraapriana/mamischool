...
public class DialogDeleteDescription extends AppCompatDialogFragment {
    ...
    public DialogDeleteDescription(Activity activity){
        this.activity = activity;
    }
    public DialogDeleteDescription(){}
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                DocumentReference noteRef = fStore.collection("schoolDescription").document(header);
