...
public class DialogDeleteFacility extends AppCompatDialogFragment {
    ...
    public DialogDeleteFacility(Activity activity){
        this.activity = activity;
    }
    public DialogDeleteFacility(){}
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                DocumentReference noteRef = fStore.collection("schoolFacilities").document(header);
