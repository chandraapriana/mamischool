...
public class DialogFacilities extends AppCompatDialogFragment {
    ...
    public DialogFacilities(Activity activity){
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.layout_dialog_facilities,null);
        btnChooseImage = view.findViewById(R.id.btn_choose_img_facilities);
        imageUpload = view.findViewById(R.id.img_thumbnail_facilities);
        ...
        cpTitle = view.findViewById(R.id.facilities_title);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    CollectionReference documentReference = fStore.collection("schoolFacilities");
